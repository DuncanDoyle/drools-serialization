...
import org.jboss.ddoyle.drools.demo.serialization.AbstractFileKieSessionLoader;
...
public class Main {
	...
	private static KieSession loadKieSession(KieBase kieBase) {
		KieSessionLoader loader = new DefaultFileKieSessionLoader(new File(DROOLS_SERIALIZED_KIESESSION_FILENAME));
		return loader.load(kieBase);
	}
